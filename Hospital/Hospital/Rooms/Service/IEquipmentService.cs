...
namespace Hospital.Rooms.Service
{
    public interface IEquipmentService
    {
        ...
        bool CreateEquipment(string id, string name, Equipment.Type type, int quantity, string roomId);

        bool UpdateEquipment(string id, string name, Equipment.Type type, int quantity, string roomId); 
